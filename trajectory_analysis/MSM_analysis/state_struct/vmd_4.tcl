...
mol new ./state_4.pdb type pdb first 0 last -1 step 1 filebonds 1 autobonds 1 waitfor all
mol delrep 0 top
mol representation NewCartoon 0.300000 10.000000 4.100000 0
mol color ColorID 6
mol selection {all}
...
mol representation VDW 1.000000 12.000000
mol color ColorID 3
mol selection {resid 90 138 and name CA}
mol material Opaque
mol addrep top

set sel [atomselect top "resid 90 138 and name CA"]
...
set sel1 [atomselect 0 "resid 1 to 501 and not (resid 90 to 138 318 to 337) and name CA"]
set sel2 [atomselect 1 "resid 1 to 501 and not (resid 90 to 138 318 to 337) and name CA"]
